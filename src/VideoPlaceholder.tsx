  ...
  return !CustomVideoPlaceholder ? (
    ...
    >
      <div style={style.imgContainer}>
        <img
          style={style.img}
          src=''
        />
      </div>
      {props.isShown && (
        <div
